...
class ListBodyScreen extends StatefulWidget {
  const ListBodyScreen({super.key});

  @override
  State<ListBodyScreen> createState() => _ListBodyScreenState();
}

class _ListBodyScreenState extends State<ListBodyScreen> {
  late DateTime selectedDate;
  bool isLoading = false;
  TextEditingController searchController = TextEditingController();
  List<CekBodyModel> datas = [];
  ...
  List<CekBodyModel> filteredDatas = [];
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<CekBodyModel> tamuList =
            data.map((json) => CekBodyModel.fromJson(json)).toList();
  ...
  void navigateToFormKendaraan() async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => FormCekBody()),
    );
                  ...
                  : filteredDatas.length == 0
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            CekBodyModel data = filteredDatas[index];
