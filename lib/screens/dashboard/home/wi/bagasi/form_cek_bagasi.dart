...
class FormCekBagasi extends StatefulWidget {
  const FormCekBagasi({super.key});

  @override
  State<FormCekBagasi> createState() => _FormCekBagasiState();
}

class _FormCekBagasiState extends State<FormCekBagasi> {
  ...
  TextEditingController _perwakilanController = TextEditingController();
  TextEditingController _supervisiController = TextEditingController();
  TextEditingController _waktuStartController = TextEditingController();
  TextEditingController _waktuSelesaiController = TextEditingController();
  ...
  */
  ...
  Future<void> _uploadData() async {
    ...
    try {
      ...
      request.fields['data'] = '{"deskripsi":"' +
          ...
          '", "nama_perwakilan":"' +
          _perwakilanController.text +
          '", "nama_supervisor":"' +
          _supervisiController.text +
          '", "waktu_mulai":"' +
          _waktuStartController.text +
          '", "waktu_selesai":"' +
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Cek Bagasi'),
        centerTitle: true,
      ),
      body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                */
                ...
                TextFormField(
                  controller: _perwakilanController,
                  //maxLines: 4,
                  decoration: InputDecoration(
                    labelText: 'Nama Perwakilan Mitra (opsional)',
                  ),
                ),
                TextFormField(
                  controller: _supervisiController,
                  //maxLines: 4,
                  decoration: InputDecoration(
                    labelText: 'Nama Supervisi KJM (opsional)',
                  ),
                ),
                TextFormField(
                  controller: _waktuStartController,
                  //maxLines: 4,
                  decoration: InputDecoration(
                    labelText: 'Waktu Mulai Sidak (wajib)',
                  ),
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'Masukkan Waktu Mulai Sidak';
                    }
                    return null;
                  },
                ),
                TextFormField(
                  ...
                  //maxLines: 4,
                  decoration: InputDecoration(
                    labelText: 'Waktu Selesai Sidak (wajib)',
                  ),
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'Masukkan Waktu Mulai Sidak';
