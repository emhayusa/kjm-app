...
class FormCekLoker extends StatefulWidget {
  const FormCekLoker({super.key});

  @override
  State<FormCekLoker> createState() => _FormCekLokerState();
}

class _FormCekLokerState extends State<FormCekLoker> {
  ...
  */
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Cek Loker'),
        centerTitle: true,
      ),
      body: Padding(
                ...
                */
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Nama Petugas Sidak (wajib)',
                  ),
                  validator: (value) {
                    if (value!.isEmpty) {
