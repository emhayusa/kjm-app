...
import 'package:kjm_app/model/presensi.model.dart';
import 'form_presensi.dart';
import 'dart:convert';

import 'package:shared_preferences/shared_preferences.dart';

class MainKehadiran extends StatefulWidget {
  const MainKehadiran({super.key});

  @override
  State<MainKehadiran> createState() => _MainKehadiranState();
}

class _MainKehadiranState extends State<MainKehadiran> {
