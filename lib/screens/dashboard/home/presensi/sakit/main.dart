...
import 'form_sakit.dart';
import 'dart:convert';

import 'package:shared_preferences/shared_preferences.dart';

class MainSakit extends StatefulWidget {
  const MainSakit({super.key});

  @override
  State<MainSakit> createState() => _MainSakitState();
}

class _MainSakitState extends State<MainSakit> {
  ...
  String apiUrl = 'https://satukomando.id/api-prod/sakit/user/';
  ...
  void navigateToFormSakit() async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => FormSakit()),
    );
